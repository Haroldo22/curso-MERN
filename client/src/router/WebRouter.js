...
export function WebRouter() {
  ...
  return (
    <Routes>
        ...
        <Route path="/blog/:path" element={ loadLayout(ClientLayout, Post) }/> {/**El :path sirve para dejarlo como variable ya que la direccion de los post se generara de manera dinamica*/}
    </Routes>
  )
}
