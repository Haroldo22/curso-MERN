...
export function RegisterForm(props) {
  ...
  return (
    <Form className='register-form' onSubmit={formik.handleSubmit}>
      ...
      <Form.Checkbox name='conditionsAccepted' label='He leido y aceptado las politicas de privacidad' onChange={(_,data)=> formik.setFieldValue('conditionsAccepted', data.checked)} checked={formik.values.conditionsAccepted} error={formik.errors.conditionsAccepted}/>
